...
export const date = DateTime.now().setZone('Europe/London').plus({ days: 2 }).toISODate()
export const pastDate = DateTime.now().setZone('Europe/London').minus({ days: 1 }).toISODate()
