...
describe('Enter the date and time of the appointment', () => {
  ...
  describe('Page is rendered', () => {
    ...
    it('should display the circumstances', () => {
      dateTimePage.getSummaryLink().click()
      dateTimePage.getElement('disability').find('dt').should('contain.text', 'Disability')
      dateTimePage
        .getElement('disability')
        .find('dd')
      ...
      dateTimePage.getElement('provisions').find('dt').should('contain.text', 'Reasonable adjustments')
      dateTimePage
        .getElement('provisions')
        .find('dd')
        .should('contain.text', 'Handrails')
        .should('contain.text', 'Behavioural responses/Body language')
      dateTimePage.getElement('dependents').find('dt').should('contain.text', 'Dependents')
      dateTimePage.getElement('dependents').find('dd').should('contain.text', 'Has Dependents')
      dateTimePage.getElement('employment').find('dt').should('contain.text', 'Employment')
      dateTimePage
        .getElement('employment')
        .find('dd')
        .should('contain.text', 'Volunteering')
        .should('contain.text', 'Full Time Employed')
      dateTimePage.getElement('relationship').find('dt').should('contain.text', 'Relationship')
      dateTimePage.getElement('relationship').find('dd').should('contain.text', 'Married / Civil partnership')
    })
  })
