...
context('Upcoming appointments', () => {
  ...
  it('Upcoming appointments page is rendered', () => {
    ...
    page
      ...
      .should('have.attr', 'href', 'http://localhost:3007/caseload/appointments/upcoming?page=1')
      .should('have.attr', 'aria-current', 'page')
    page
      .getPaginationItem(2)
      .find('a')
      .should('contain.text', '2')
      .should('have.attr', 'href', 'http://localhost:3007/caseload/appointments/upcoming?page=2')
      .should('not.have.attr', 'aria-current', 'page')
    page
      .getPaginationItem(3)
      .find('a')
      .should('contain.text', '3')
      .should('have.attr', 'href', 'http://localhost:3007/caseload/appointments/upcoming?page=3')
      .should('not.have.attr', 'aria-current', 'page')
    page
      .getPaginationItem(4)
      .find('a')
      .should('contain.text', '4')
      .should('have.attr', 'href', 'http://localhost:3007/caseload/appointments/upcoming?page=4')
      .should('not.have.attr', 'aria-current', 'page')

    page.getPaginationItem(5).should('contain.text', '⋯')
  ...
  it('Upcoming appointments page 2 is rendered', () => {
    ...
    page.getPaginationItem(2).find('a').should('contain.text', '2').should('have.attr', 'aria-current', 'page')
    page.getPaginationItem(3).find('a').should('contain.text', '3').should('not.have.attr', 'aria-current', 'page')
    page.getPaginationItem(4).find('a').should('contain.text', '4').should('not.have.attr', 'aria-current', 'page')
    page.getPaginationItem(5).find('a').should('contain.text', '5').should('not.have.attr', 'aria-current', 'page')
  ...
  it('Upcoming appointments page 5 is rendered', () => {
    ...
    cy.get('.govuk-pagination__prev')
      ...
      .should('contain.text', 'Previous')
      .should('have.attr', 'href', 'http://localhost:3007/caseload/appointments/upcoming?page=4')
    page.getPaginationItem(1).should('contain.text', '⋯')
    page.getPaginationItem(2).find('a').should('contain.text', '2').should('not.have.attr', 'aria-current', 'page')
    page.getPaginationItem(3).find('a').should('contain.text', '3').should('not.have.attr', 'aria-current', 'page')
    page.getPaginationItem(4).find('a').should('contain.text', '4').should('not.have.attr', 'aria-current', 'page')
    page.getPaginationItem(5).find('a').should('contain.text', '5').should('have.attr', 'aria-current', 'page')
    page.getPaginationItem(6).find('a').should('contain.text', '6').should('not.have.attr', 'aria-current', 'page')
  })
