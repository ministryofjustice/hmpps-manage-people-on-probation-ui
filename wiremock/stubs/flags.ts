      ...
      jsonBody: {
        ...
        flags: [
          ...
          },
          {
            ...
            {
                key: 'enableSingleFileUpload',
                name: 'enableSingleFileUpload',
                description: '',
                enabled: true,
                type: 'BOOLEAN_FLAG_TYPE',
                createdAt: '2025-11-26T15:28:37.920581Z',
                updatedAt: '2025-11-26T17:06:39.269084Z',
                rules: [],
                rollouts: [],
            },
        ],
...
const stubEnableSingleFileUpload = (): SuperAgentRequest =>
    superagent.post('http://localhost:9091/__admin/mappings').send({
        request: {
            urlPathPattern: '/flipt/internal/v1/evaluation/snapshot/namespace/manage-people-on-probation-ui',
            method: 'GET',
