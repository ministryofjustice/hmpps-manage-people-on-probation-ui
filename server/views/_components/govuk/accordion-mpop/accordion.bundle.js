  ...
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
        factory((global.GOVUKFrontend = global.GOVUKFrontend || {})))
    ...
    constructor(componentOrMessage) {
      const message =
        typeof componentOrMessage === 'string'
          ? componentOrMessage
          : formatErrorMessage(componentOrMessage, `Root element (\`$root\`) already initialised`)
      super(message)
      this.name = 'InitError'
    }
  }
    ...
    constructor($root, config) {
      ...
      if (!isObject(childConstructor.defaults)) {
        throw new ConfigError(
          formatErrorMessage(childConstructor, 'Config passed as parameter into constructor but no defaults defined'),
        )
      }
      const datasetConfig = normaliseDataset(childConstructor, this._$root.dataset)
      this._config = mergeConfigs(
