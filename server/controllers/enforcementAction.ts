...
const routes = [
  'getAllEnforcementActions',
] as const

const enforcementActionController: Controller<typeof routes, void> = {
  getAllEnforcementActions: hmppsAuthClient => {
...
export default enforcementActionController