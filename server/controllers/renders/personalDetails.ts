...
import { toRoshWidget, toPredictors, toIsoDateFromPicker } from '../../utils/utils'
...
type Controller<T extends readonly string[]> = {
  [K in T[number]]: (hmppsAuthClient: HmppsAuthClient) => Route<Promise<void>>
}

export const personalDetailsController: Controller<typeof routes> = {
  personalDetails: hmppsAuthClient => {
  ...
  personalContact: hmppsAuthClient => {
    return async (req, res) => {
  ...
  personalContactNote: hmppsAuthClient => {
    return async (req, res) => {
  ...
  mainAddressNote: hmppsAuthClient => {
    return async (req, res) => {
  ...
  documentsDownload: hmppsAuthClient => {
    return async (req, res) => {
      const { crn } = req.params
  ...
  disabilitiesNote: hmppsAuthClient => {
    return async (req, res) => {
  ...
  adjustmentsNote: hmppsAuthClient => {
    return async (req, res) => {
  ...
  circumstancesNote: hmppsAuthClient => {
    return async (req, res) => {
