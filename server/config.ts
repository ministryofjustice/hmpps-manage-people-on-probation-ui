...
export default {
  ...
  apis: {
    ...
    emdiApi: {
      url: get('EMDI_API_URL', 'http://localhost:8100', requiredInProduction),
      timeout: {
        response: Number(get('EMDI_API_TIMEOUT_RESPONSE', 10000)),
        deadline: Number(get('EMDI_API_TIMEOUT_DEADLINE', 10000)),
      },
