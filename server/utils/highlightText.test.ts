...
describe('utils/highlightText', () => {
  ...
  const expected = [
    ...
    { ...doc, name: 'Hi world', filenameHighlighted: 'Hi <span class="govuk-tag--yellow">world</span>' },
    { ...doc, name: 'The world is round', filenameHighlighted: 'The <span class="govuk-tag--yellow">world</span> is round' },
  ...
  it('should highlight the word in the filename within the list of documents', () => {
    expect(highlightText('world', docs)).toEqual(expected)
  })
