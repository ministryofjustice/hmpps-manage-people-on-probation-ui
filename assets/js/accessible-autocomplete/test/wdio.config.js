...
const { PORT = 4567, SAUCE_ACCESS_KEY, SAUCE_BUILD_NUMBER, SAUCE_ENABLED, SAUCE_USERNAME } = process.env
...
exports.config = {
  ...
  capabilities: SAUCE_ENABLED === 'true' ? capabilitiesSauce : capabilitiesLocal,
